...
app.constant('JS_REQUIRES', {
    scripts: [
        ...
        }, {name:  'executionContextDetailController',
            files: ['assets/js/controllers/executionContextDetailController.js']
        }, {name:  'executionContextListController',
            files: ['assets/js/controllers/executionContextListController.js']
        }
    ],
    modules: [
        {name: 'ngTable',
